...
import pandas as pd
t1 = []            
for text in glob.glob("F:\HINDI_CORPUS\AU\AU-2020-APR\AU-2020-APR-*.txt"):       #To print data of 1 April.
...
mc_10=fdist.most_common(10)
df= pd.DataFrame (mc_10, columns =[ 'WORDS' ,'FREQUENCY'])        #Creating a dataframe.
